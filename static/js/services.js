...
<a href="templates/services.html">
    <button id="verMasServicios" class="fixed bottom-1/2 right-4 z-30 transform -translate-y-1/2 bg-gradient-to-r from-blue-800 to-blue-600 text-white font-semibold px-6 py-3 rounded-full shadow-lg flex items-center space-x-3 transition-all duration-300 ease-in-out hover:shadow-2xl hover:from-blue-700 hover:to-blue-500 hover:scale-110">
